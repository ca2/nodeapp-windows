...
Gdiplus::Status gdiplus_draw_text(Gdiplus::Graphics * p, Gdiplus::GraphicsPath * p2, const string & str, rectd & rectParam, UINT nFormat, Gdiplus::Font * pfont, double dFontWidth, Gdiplus::Brush * pbrush = NULL, bool bMeasure = false);
